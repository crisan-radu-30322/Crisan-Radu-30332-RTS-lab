...
class JoinTestThread extends Thread{
    ...
    public void run(){
        System.out.println("Thread " + this.getName() + " has enetered the run() method");
        try{
            if(t != null)t.join();
...
public class Main {
    public static void main(String[] args){
        ...
        JoinTestThread w1 = new JoinTestThread("Thread 1",null,9);

        JoinTestThread w2 = new JoinTestThread("Thread 2",w1,15);
